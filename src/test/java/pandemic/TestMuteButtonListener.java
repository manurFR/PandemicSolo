...
* @since v2.6
*/
public class TestMuteButtonListener {

	/*@Test
	public void testActionPerformed() {
		BoardView mockView = mock(BoardView.class);
		ActionEvent mockEvent = mock(ActionEvent.class);
		
		MuteButtonListener listener = new MuteButtonListener(mockView);
		
		listener.actionPerformed(mockEvent);
		
		verify(mockView).muteIconChanged();		
	}*/
