...
public class TestComponentsFactory {
	...
	private GameConfig basicConfig;
	private GameConfig advancedConfig;
	...
	@Test
	public void testCreateCubesWithPurple() {
		when(mockResourceProvider.getBundle(anyString())).thenReturn(
				new MockBundle("cubes.RED", "814;150;1;\"swuerfel_rot.jpg\""));
		
		List<Cube> cubes = componentsFactory.createCubes(advancedConfig.getDiseases());
	...
	@Test
	public void testCreateCubesWithoutPurple() {
		when(mockResourceProvider.getBundle(anyString())).thenReturn(
				new MockBundle("cubes.RED", "814;150;1;\"swuerfel_rot.jpg\""));
		
		List<Cube> cubes = componentsFactory.createCubes(basicConfig.getDiseases());
	...
	public void testCreateRoles()
	{
		...
		assertEquals(11, pawns.size()); // With expansion roles, there is 11 of them
	...
	public void testCreateCureMarkers()
	{
		...
		// With purple
		List<PandemicObject> markers = componentsFactory.createCureMarkers(advancedConfig.getDiseases());
		...
		// Without purple
		markers = componentsFactory.createCureMarkers(basicConfig.getDiseases());
	...
	public void testCreateEradicationMarkers()
	{
		...
		List<PandemicObject> markers = componentsFactory.createEradicationMarkers(advancedConfig.getDiseases());
		...
		markers = componentsFactory.createEradicationMarkers(basicConfig.getDiseases());
	...
	@Test
	public void testCreateSpecialEvents()
	{
